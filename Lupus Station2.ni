...
Kontaminierter Kapitän is a Kontaminierter in Brücke.
Kontaminierter erster Offizier is a Kontaminierter in Brücke. 
...
Mikrofone is a thing on the Gegensprechanlage. Mikrofone is fixed in place.
Mikrofonknopf is on Mikrofone.
The description of the Mikrofone is " Das Mikrofon gehört anscheinend zu der Gegensprechanlage, vielleicht sollte ich es einmal ausprobieren.".
Mikrofonknopf is a device. Mikrofonknopf is switched off.
The description of the Mikrofonknopf is "Dieser Knopf schaltet wahrscheinlich das Mikrofone an.".
...
Der Dienstraum hier drunter hatte mehr Charm. Im Westen geht es zur Brücke".
...
The Description of Antennenfeld L is "Über diesem Raum scheinen die Antennen der Forschungsstation zu sein. Ein großer roter Knopf…der scheint wichtig zu sein. Unter dir geht es zurück zum Kom-Modul.".
...
After switching on roter Notrufknopf:
	...
	say "Der Sauerstoffstatus ist niedrig und der Alarm ist wieder angegangen.";
...
The Description of Hangar is "Ein Raum verlassen wie jeder andere. Der Spind neben der Tür im Westen lädt einen ein, um reinzugucken. Im Osten steht unsere Fähre und im Westen muss der Zugang zum äußeren Ring sein.".
...
The Description of Gamma Kreuzung is "Du befindest dich im östlichen Teil des äußeren Rings. Durch das Fenster sieht man die undendlichen Weiten des Alls. 
...
The description of the Kittel is "Vielleicht ist etwas im  Kittel des Wissenschaftlers drin.".
...
The Description of Delta Kreuzung is "Was sind das hier für Geräusche, kommen die aus dem Raum im Süden? Südwestlich geht es zum Alpha-Delta-Korridor und südöstlich zurück zum Gamma-Delta-Korridor.".
PanelDK-ADK is an closed container in Delta Kreuzung. The PanelDK-ADK is unopenable. The PanelDK-ADK is fixed in place. The description of the PanelDK-ADK is "Das Panel, was die Tür öffnet, ist durch den Alarm gesperrt. Vielleicht kann ich diese Blockade umgehen.". 


Section - Alpha-Delta Korridor

Alpha-Delta Korridor is a room.
The Description of Alpha-Delta Korridor is "Ein Raum mit einem Panel zum Öffnen der Tür, lediglich eine Tür im Nordosten zur Delta-Kreuzung und eine im Südwesten zur Alpha-Kreuzung.".

Kontaminierter Forscher is a Kontaminierter. Kontaminierter Forscher is in Alpha-Delta Korridor.
PanelADK-DK is an closed container in Alpha-Delta Korridor. the panelADK-DK is unopenable. the panelADK-DK is fixed in place. The description of the PanelADK-DK is "Das Panel, was die Tür öffnet, ist durch den Alarm gesperrt. Vielleicht kann ich diese Blockade umgehen.". 
Panel ADK-AK is an closed container in Alpha-Delta Korridor.The Panel ADK-AK is unopenable.The Panel ADK-AK is fixed in place. The description of the Panel ADK-Ak is "Das Panel, was die Tür öffnet, ist durch den Alarm gesperrt. Vielleicht kann ich diese Blockade umgehen.". 
...
Im Osten ist das Med-Labor, im Westen der Dienstraum.
Südöstlich geht’s zum Alpha-Beta-Korridor und nordöstlich zum Alpha-Delta-Korridor."

PanelAK-ADK is a closed container in Alpha Kreuzung. the panelAK-ADK is unopenable. the panelAK-ADK is fixed in place. The description of the PanelAK-ADK is "Das Panel, was die Tür öffnet, ist durch den Alarm gesperrt. Vielleicht kann ich diese Blockade umgehen.".  
Panel AK-ABK is an closed container in Alpha Kreuzung.The Panel AK-ABK is unopenable.The Panel AK-ABK is fixed in place. The description of the Panel Ak-ABK is "Das Panel, was die Tür öffnet, ist durch den Alarm gesperrt. Vielleicht kann ich diese Blockade umgehen.". 
...
Nordwestlich geht es zur Alpha-Kreuzung und südwestlich zur Beta-Kreuzung.".

PanelABK-AK is an closed container in Alpha-Beta Korridor. the panelABK-AK is unopenable. the panelABK-AK is fixed in place. The description of the PanelABK-Ak is "Das Panel, was die Tür öffnet, ist durch den Alarm gesperrt. Vielleicht kann ich diese Blockade umgehen.". 
Panel ABK-BK is an closed container in the Alpha-Beta Korridor. The Panel ABK-BK is unopenable. The Panel ABK-BK is fixed in place. The description of the Panel ABK-BK is "Das Panel, was die Tür öffnet, ist durch den Alarm gesperrt. Vielleicht kann ich diese Blockade umgehen.". 
...
The Description of Beta Kreuzung is "Es ist ganz schön laut hier, der Lärm scheint aus dem nördlichen Maschinenraum zu kommen.
Im Süden ist sogar ein Damen WC, welches aber außer Betrieb zu sein scheint.
Nordwestlich geht es zum Alpha-Beta-Korridor und nordöstlich zum Gamma-Beta-Korridor, der zur Andockstation und Xeno-Lab führt.".

PanelBK-ABK is an closed container in Beta Kreuzung. the panelBK-ABK  is unopenable. the panelBK-ABK is fixed in place. The description of the PanelBK-ABK is "Das Panel, was die Tür öffnet, ist durch den Alarm gesperrt. Vielleicht kann ich diese Blockade umgehen.".  
...
Südwestlich geht es zur Beta-Kreuzung und nordöstlich zur Gamma-Kreuzung.".
...
the description of the Akkubohrer is "Dieses ist nicht einfach nur ein Akkubohrer, es ist ein Hyper-Super-Megadrive Akkubohrer. Das macht ihn aber auch ziemlich laut.“.
...
Akku1 is a thing in Maschinenraum. the description of the Akku1 is "Dies ist ein sogenannter Akkumulator, was akkumuliert er nur?“.
akku1counter is a number which varies.
akku1counter is 5.

Akku2 is a thing in Spind. the description of the Akku2 is "Dies ist ein sogenannter Akkumulator, was akkumuliert er nur?“.
...
Check using Akkubohrer on something:
	if Akku1 is not in Akkubohrer:
		if Akku2 is not in Akkubohrer:
			say "Du hast keinen Akku im Akkubohrer." instead;
...
blogstate is a truth state which varies.
...
Pult is a supporter in Med-Labor. The description of Pult is "Auf dem Pult befindet sich ein Knopf mit der Beschriftung 'Videos'. Du solltest den Knopf anschalten und dir ein wenig Zeit vertreiben."
...
After switching on Knopf:
	...
	now Alarm is in Alarm-reg;
	repeat with i running through the Kontaminierter in Med-Labor:
		now aufmerksam of i is true;
	say "Durch die Lautstärke des Abspielens des Videoblogs, sind alle Kontaminierten im Raum aufmerksam auf dich geworden, sei vorsichtig.";
	now blogstate is true;
	
every turn:
	[erst ab Szene 4 offen, da sonst zu viele Kontaminierte im Lager sind]
	if Szene 4 is happening:
		if blogstate is true:
			if Alarm is not in Alarm-reg:
				if TürBRÜ-BR is locked:
					now TürBRÜ-BR is unlocked;
					say "Die Tür zur Brücke ist nun entriegelt.";
...
The Description of Solar-Labor is "Dies scheint auch ein Forschungsraum zu sein. Auch von hier aus sieht man den Maschinekern. Anscheinend wie jeder Raum des inneren Rings auf dieser Etage. Nach Norden geht es zurück zur Delta-Kreuzung.".
...
the description of the wandpanel is "In diesem Wandpanel verbirgt sich etwas höchst Interessantes.".
Grüne Phiole is a thing. Grüne Phiole is in Wandpanel. 
the description of the grüne Phiole is "Die Phiole schimmert grün. Es scheint so, als könnte ein Gas enthalten sein. Worum könnte es sich hierbei nur handeln?".

Before switching on Blinkender Knopf:
	if Szene 2 is happening:
		say "Ich sollte lieber Percy retten." instead;

After switching on Blinkender Knopf:
	if Szene 1 is happening:
		if Wandpanel is closed:
			say "Endlich Ruhe... Warte was schimmert dort so grün aus dem Wandpanel???";
			now Wandpanel is open;
		else:
			say "Der Alarm is doch schon aus und das Wandpanel offen.";
...
The description of the Toilette is "Diese Toilette hat wohl ihre besten Zeiten schon hinter sich.".  
...
Carry out shooting it with:
	...
	say "Der Komtaminierte hat sich in Staub aufgelöst. Geil!";
...
The Description of Dienstraum is "Dieser Raum sieht nach Arbeit aus. Zum Glück kann man von hier aus nach oben zum Besprechungsraum, nach unten in  die Mensa und nach Osten zur Alpha-Kreuzung flüchten.".
...
if the player is in the Alpha-Delta Korridor begin;
	if PanelADK-DK is closed begin;
...
Before opening TürDK-ADK:
if the player is in the Delta Kreuzung begin;
	if PanelDK-ADK is closed begin;
		say "Die Tür kann nicht mit dem Sicherheitsausweis entsperrt werden! Zumindest im Moment nicht, probieren sie es einmal mit dem PanelDK-ADK." instead;
	else if the player is not carrying the Sicherheitskarte;
		say "Um die Tür automatisch zu entsperren, damit Sie passieren können, müssen Sie die Sicherheitskarte bei sich tragen." instead;
	end if;
	end if;
...
if the player is in the Alpha Kreuzung begin;
	if PanelAK-ADK is closed begin;
...
Before closing TürADK-AK:
	...
	Before opening TürADK-AK:
	if the player is in the Alpha-Delta Korridor begin; 
	if Panel ADK-AK is closed begin;
		say "Die Tür kann nicht mit dem Sicherheitsausweis entsperrt werden! Zumindest im Moment nicht, probieren sie es einmal mit dem PanelADK-AK." instead;
	else if the player is not carrying the Sicherheitskarte;
		say "Um die Tür automatisch zu entsperren, damit Sie passieren können, müssen Sie die Sicherheitskarte bei sich tragen." instead;
end if;
end if;
...
if the player is in the Alpha-Beta Korridor begin;
	if PanelABK-AK is closed begin;
...
Before opening TürAK-ABK:
if the player is in the Alpha Kreuzung begin;
	if Panel AK-ABK is closed begin;
		say "Die Tür kann nicht mit dem Sicherheitsausweis entsperrt werden! Zumindest im Moment nicht, probieren sie es einmal mit dem PanelAK-ABK." instead;
	else if the player is not carrying the Sicherheitskarte;
		say "Um die Tür automatisch zu entsperren, damit Sie passieren können, müssen Sie die Sicherheitskarte bei sich tragen." instead;
end if;
end if;
...
if the player is in the Beta Kreuzung begin;
	if PanelBK-ABK is closed begin;
...
Before closing TürABK-BK: 
	...
	Before opening TürABK-BK:
	if the player is in the Alpha-Beta Korridor begin;
	if Panel ABK-BK is closed begin;
		say "Die Tür kann nicht mit dem Sicherheitsausweis entsperrt werden! Zumindest im Moment nicht, probieren sie es einmal mit dem PanelABK-BK." instead;
	else if the player is not carrying the Sicherheitskarte;
		say "Um die Tür automatisch zu entsperren, damit Sie passieren können, müssen Sie die Sicherheitskarte bei sich tragen." instead;
		end if;
		end if; 
...
TürXenoLab is west of Gamma Kreuzung. TürXenoLab is east of Xeno-Labor. TürXenoLab is a door.
TürXenoLab is locked.
The Description of TürXenoLab is "Tür zwischen Gamma Kreuzung und Xeno-Labor: Du benötigst die Xenokarte um diese Tür zu öffnen. Tür bleibt nur 5 Sekunden geöffnet und schließt dann wieder. Tür kann mit einem Fass blockiert werden, sodass die Tür für immer offen bleibt.".
...
the description of the panel is "Dieses Panel öffnet, hoffentlich diese schicke Tür.“.
...
every turn:
if the fass is in the Xeno-Labor begin;
  now TürXenoLab is unlocked;
  now TürXenoLab is open;
...
if panelcounter is  2  begin;
   decrease panelcounter by 2 ;
	now TürXenoLab is closed;
	now  TürXenoLab  is locked;
...
TürMaschinenraum is north of Beta Kreuzung. TürMaschinenraum is south of Maschinenraum. TürMaschinenraum is a door.
The Description of TürMaschinenraum is "Tür zwischen Beta Kreuzung und Maschinenraum: Tür offen.".

[Delta Kreuzung <-> Solar-Labor]
TürSolarLab is south of Delta Kreuzung. TürSolarLab is north of Solar-Labor. TürSolarLab is a door.
The Description of TürSolarLab is "Tür zwischen Delta Kreuzung und Solar-Labor: Tür offen.".

[Alpha Kreuzung <-> Med-Labor]
TürMedLab is east of Alpha Kreuzung. TürMedLab is west of Med-Labor. TürMedLab is a door.
The Description of TürMedLab is "Tür zwischen Alpha Kreuzung und Med-Labor: Tür offen.".

[Beta Kreuzung <-> WC-Damen]
TürWCDamen is south of Beta Kreuzung. TürWCDamen is north of WC-Damen. TürWCDamen is a door.
TürWCDamen is locked.
The Description of TürWCDamen is "Tür zwischen Beta Kreuzung und WC-Damen: Tür lässt sich erst in Szene 4 nach Abschluss der Dekontaminierung öffnen.".
...
[Hangar <-> Umkleideraum]
TürUmkleide is south of Hangar. TürUmkleide is north of Umkleideraum. TürUmkleide is a door.
TürUmkleide is locked.
The description of the TürUmkleide is "Tür zwischen Hangar und Umkleideraum: Öffnet sich nach dem alle Kontamnierten im Lager sind.".


[Andockstation <-> Kommunikationsmodul]
Außeneinstieg is northwest of Andockstation. Außeneinstieg is southeast of Kommunikationsmodul. Außeneinstieg is a door.
The Description of Außeneinstieg is "Tür zwischen Andockstation und Kommunkationsmodul: Bitte Raumanzug anziehen, da du im Weltall sonst nicht überlebst.".

Before going through the Außeneinstieg:
...
Eine Tür zum verlassen des Raumes befindet sich im Nordosten zum Delta-Gewächshaus und im Südosten zum Beta-Gewächshaus.".
...
Ob es im Lager südöstlich von hier genauso aussieht?
Südwestlich geht es wieder zum Lagerraum.".
...
Südwestlich geht es zum Beta-Gewächshaus und nordwestlich zum Delta-Gewächshaus. ".
...
Nordöstlich geht es in das Lager und nordwestlich in den Lagerraum.".
...
Du kannst hoch zum Dienstraum oder zum äußeren Ring der unteren Ebene zum Lagerraum.".
...
the description of the fluchtkapsel is "Die Fluchtkapsel ist groß genug für zwei Personen.".

Before switching on Launch-Schalter:
	if sauerstoffabfallbeginn is 0:
		say "Du willst schon flüchten? Versuche doch das Stationspersonal sicher zu versperren oder wenigstens einen Notruf abzusetzen!" instead;
...
The Description of Transporterraum is "Dies ist die Verbindung zur Raumstation. GEH IN den Transporter um dorthin zu gelangen.
